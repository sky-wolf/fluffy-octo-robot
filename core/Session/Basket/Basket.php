...
namespace Kinnekulle\Basket;

use Kinnekulle\Basket\Exceptions\QuantityExceededException;
use Kinnekulle\Support\Storage\Contracts\StorageInterface;
use Kinnekulle\Models\Product;
...
class Basket
{
    ...
    {
        $this->storage->unsets($product->id);
    }
    ...
    public function claer(Product $product)
    {
        return $this->storage->clear();
    }

    public function claerall()
    {
        return $this->storage->clear();
    }
